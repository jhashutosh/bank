...
echo "<tr><td bgcolor=\"green\" colspan=\"6\" align=\"center\"><font color=\"white\"><B>List of JLG Members[$account_no]</font>";
...
// Place line comments if you do not need column header.
	...
	if(!strcmp(trim($row['account_type']),'mt')||!strcmp(trim($row['account_type']),'pl')||!strcmp(trim($row['account_type']),'sfl')||!strcmp(trim($row['account_type']),'ccl')||!strcmp(trim($row['account_type']),'spl')||!strcmp(trim($row['account_type']),'bdl')||!strcmp(trim($row['account_type']),'kpl')||!strcmp(trim($row['account_type']),'sgl')||!strcmp(trim($row['account_type']),'jgl')){
