...
//echo "<b><u><font color=\"red\">Report No. 6</u> </b></font>";
 ...
 //echo "</h3>";
echo "<form method=\"POST\" action=\"jlg_closed.php\">";
...
;
echo "<tr><td bgcolor=\"green\" colspan=\"11\" align=\"left\"><font color=\"white\"><b>Report 6: &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;JLG LOAN CLOSED ACCOUNT LIST<b></font>";// Place line comments if you do not need column header.
$color=$TCOLOR;
echo "<tr>";
...
for($j=1; $j<=pg_NumRows($result); $j++) 
{
	...
	echo "<td align=right bgcolor=$color><a href=\"jlg_mem_detail.php?group_no=".$row['group_no']."\" target=\"display\">".$row['group_no']."</a></td>";
