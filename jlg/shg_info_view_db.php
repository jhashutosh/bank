...
$sum_ri_dep=0.0;
$sum_ri_mat=0.0;
$sql_statement="SELECT * FROM customer_jlg ORDER BY CAST(SUBSTR(jlg_no,5,length(jlg_no)) AS INT)";
...
echo "<tr>";
$g_id=$row['jlg_no'];
$c_id=getCustomerIdFromJlgId($g_id);
...
$loan_amount=loan_total_balance_jlg($g_id);
...
//echo "differ:$diff";
//if($diff>0){
echo "<td align=Center bgcolor=$color ><a href=\"../jlg/kcc_loan_issue.php?menu=$menu&account_no=$g_id\" target=\"_parent\">Issue</a>/";
      //}
//else {
