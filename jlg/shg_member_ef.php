...
echo "<tr><td colspan=6 bgcolor=\"#8A2BE2\" align=center><b><font size=+2>Joint Liability  Group Member Entry Form</b></font>";
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">SHG Member id:<td  colspan=2><input type=\"TEXT\" name=\"sl_no\" size=\"10\" value=\"".$group_no."-".($count+1)."\" readonly $HIGHLIGHT>";
echo "<td align=\"Right\" colspan=2>Group no:<td><input type=\"TEXT\" name=\"group_no\" size=\"10\" value=\"$group_no\" readonly $HIGHLIGHT><br>";
if ($count==0){
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\" >Name of Member:<td colspan=2><input type=\"TEXT\" name=\"mname\" id=\"mname\" size=\"20\" value=\"$leader\" $HIGHLIGHT><br>";
echo "<input type=\"HIDDEN\" name=\"designation\"  value=\"l\">";
}
else if ($count==1){
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\" >Name of Member:<td colspan=2><input type=\"TEXT\" name=\"mname\" id=\"mname\" size=\"20\" value=\"\" $HIGHLIGHT><br>";
echo "<input type=\"HIDDEN\" name=\"designation\"  value=\"s\">";
}
else{
   echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Name of Member:<td colspan=2><input type=\"TEXT\" name=\"mname\" size=\"20\" value=\"\" id=\"mname\" $HIGHLIGHT><br>";
...
if(trim($sex)=="m"){
 echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Sex:<td><input type=\"TEXT\" name=\"sex\" size=\"10\" value=\"Male\"readonly $HIGHLIGHT><br>";
}
elseif(trim($sex)=='f'){
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Sex:<td><input type=\"TEXT\" name=\"sex\" size=\"10\" value=\"Female\"readonly $HIGHLIGHT><br>";
}
else{
    echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Sex:<td>";
...
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Village:<td><input type=\"TEXT\" name=\"address1\" size=\"15\" value=\"$VILL_DEFAULT\" $HIGHLIGHT><br>";
...
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Pin:<td><input type=\"TEXT\" name=\"pin\" size=\"10\" value=\"$PIN_DEFAULT\" $HIGHLIGHT><br>";
...
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Qualification:<td colspan=2 align=\"left\">";
...
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Voter Id. No.:<td colspan=2 align=\"left\"><input type=\"TEXT\" name=\"vcn\" size=\"15\" value=\"\" $HIGHLIGHT><br>";
echo "<td align=\"left\">Pan Card No.:<td colspan=2 align=\"left\"><input type=\"TEXT\" name=\"pan\" size=\"15\" value=\"\" $HIGHLIGHT>";
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Id Proof:<td>";
...
echo "<tr bgcolor=\"$ROWCOLOR\"><td align=\"left\">Customer Id:<td colspan=2 align=\"left\"><input type=\"TEXT\" name=\"cid\" size=\"15\" value=\"C-\" $HIGHLIGHT>";
echo "<td align=\"right\" colspan=6><input type=\"RESET\" name=\"RESET_BUTTON\" value=\"Reset\"><input type=\"SUBMIT\" name=\"SUBMIT_BUTTON\" value=\"Submit\">";
