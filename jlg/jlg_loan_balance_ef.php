...
//else {
	...
	$sql_statement.=";INSERT INTO shg_loan_ledger_hrd(loan_sl_no , member_id, account_no , shg_no ,action_date ,repay_date ,d_int_r,od_int_r, status, staff_id, entry_time ) VALUES('$loan_sl_no','".$member_info[$i]."','$account_no','$group_no','$action_date','$repay_date',$due_int,$overdue_int,'op','$staff_id', CAST('$curr_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
...
// Loan_Ledger_Hrd
	$sql_statement.=";INSERT INTO loan_ledger_hrd(loan_serial_no,loan_type,customer_id,account_no,fy,issue_date,crop_id,repay_date,int_due_rate, int_overdue_rate,status,gl_code,gl_status) VALUES ('$loan_sl_no','jgl','$c_id','$account_no','$fy1','$action_date','$typecrop','$repay_date',$due_int,$overdue_int,'op','$gl_code_loan','$gl_status')";
// loan_return_dtl
...
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks, operator_code, entry_time) VALUES ('$t_id','jgl','$curr_date','$fy1','$remarks', '$staff_id', CAST('$curr_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
		
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','$account_no','$gl_code_loan',$balance_p,'Dr','opening JGL')";
...
echo "<FORM NAME=\"orderform\" method=\"POST\" action=\"jlg_loan_balance_ef.php?menu=$menu&op=i\" onSubmit=\"return varify();\">";
echo "<table bgcolor=\"BLACK\" width=\"100%\" align=\"CENTER\">";
echo "<tr><th bgcolor=\"#006400\" colspan=\"10\">JLG Loan Balance Entry Form [$account_no]";
...
echo "<td bgcolor=\"#9370D8\">Due Interest Rate:<td bgcolor=\"#9370D8\">&nbsp;<INPUT NAME=\"d_int_r\" TYPE=\"TEXT\" VALUE=\"$due_int\" $HIGHLIGHT maxlength=\"5\" size=5 READONLY>&nbsp;%";
echo "<tr><td bgcolor=\"#9370D8\">Over Due Interest Rate:<td bgcolor=\"#9370D8\">Rs.&nbsp;<INPUT NAME=\"od_int_r\" TYPE=\"TEXT\" VALUE=\"$overdue_int\" $HIGHLIGHT size=\"5\" maxlength=\"5\" READONLY>&nbsp;%";
...
//echo "<td align=\"left\" bgcolor=\"#9370D8\">Period :<td bgcolor=\"#9370D8\"><input type=\"TEXT\" name=\"repay_date\" size=\"12\" value=\"$repay_date\" $HIGHLIGHT READONLY>&nbsp;Months";
...
//echo "<tr><td bgcolor=\"#9370D8\">Issuing Date:<td bgcolor=\"#9370D8\"><INPUT NAME=\"action_date\" TYPE=\"TEXT\" VALUE=\"$action_date\" $HIGHLIGHT size=\"12\" READONLY>";
echo "<td bgcolor=\"#9370D8\"><td bgcolor=\"#9370D8\">";
echo "<tr bgcolor=\"#9370D8\"><td colspan=\"6\" align=\"center\">Crop:<input type=\"TEXT\" name=\"type2\" size=\"20\" value=\"".$typecrop."\"  $HIGHLIGHT>";
echo "<td bgcolor=\"#9370D8\"><td bgcolor=\"#9370D8\">";

echo "</table>";
//echo "<tr> ";
echo "<table bgcolor=\"BLACK\" width=\"100%\" align=\"CENTER\">";
echo "<tr><th bgcolor=\"WHITE\" colspan=\"7\">SHG Group Details of Loan [$account_no]";
...
echo "<FORM NAME=\"f1\" method=\"POST\" action=\"jlg_loan_balance_ef.php?menu=$menu&op=v\">";
echo "<TR><td bgcolor=\"#E6E6FA\">Loan Account No:<td bgcolor=\"#E6E6FA\"><INPUT NAME=\"account_no\" TYPE=\"TEXT\" VALUE=\"JGL-\" $HIGHLIGHT size=\"12\" id=\"account_no\" >";
...
echo "<tr><td bgcolor=\"#E6E6FA\">Due Interest Rate:<td bgcolor=\"#E6E6FA\">Rs.&nbsp;<INPUT NAME=\"d_int_r\" TYPE=\"TEXT\" VALUE=\"7\" $HIGHLIGHT maxlength=\"5\" size=5>&nbsp;%";
echo "<td bgcolor=\"#E6E6FA\">Over Due Interest Rate:<td bgcolor=\"#E6E6FA\">Rs.&nbsp;<INPUT NAME=\"od_int_r\" TYPE=\"TEXT\" VALUE=\"10.50\" $HIGHLIGHT size=\"5\" maxlength=\"5\">&nbsp;%";
...
echo "<td align=\"left\" bgcolor=#E6E6FA>Crop Id:<td bgcolor=#E6E6FA>";
	//makeSelectSubmit4mdb('crop_id','crop_desc','crop_mas','cid');
makeSelect($crop_array,'typecrop','');
//echo "<td bgcolor=\"#E6E6FA\">Issuing Date:<td bgcolor=\"#E6E6FA\"><INPUT NAME=\"action_date\" TYPE=\"TEXT\" VALUE=\"\" $HIGHLIGHT size=\"12\" id=\"action_date\" >";
//echo "<tr><td align=\"left\" bgcolor=\"#E6E6FA\">Period :<td bgcolor=\"#E6E6FA\"><input type=\"TEXT\" name=\"repay_date\" size=\"3\"  $HIGHLIGHT>&nbsp;<font color=RED size=-1>Month</font>";
echo "<tr><td align=\"RIGHT\" bgcolor=\"#E6E6FA\" colspan=\"4\"><input type=\"SUBMIT\" VALUE=\"    Go   \" >";
echo "</FORM>";
    }
}
