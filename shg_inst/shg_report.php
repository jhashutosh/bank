...
echo "<li><a href=\"../general/shg_loan_recovery_rpt.php?menu=shg\" onClick=\"window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=100,left=50, width=900,height=800'); return false;\">Recovery Summary</a>";
