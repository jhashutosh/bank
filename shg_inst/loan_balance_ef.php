...
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,operator_code, entry_time) VALUES ('$t_id','sgl','$curr_date','$fy1', '$staff_id', CAST('$curr_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
if($b_d_principal>0)
...
echo "<tr><th bgcolor=\"#DBA1B2\" colspan=\"4\"><font size=+2>SHG Loan Balance Entry Form</font>";
...
echo "<TR><td bgcolor=\"#66B463\">Loan Account No:<td bgcolor=\"#66B463\"><INPUT NAME=\"account_no\" TYPE=\"TEXT\" VALUE=\"SGL-\" $HIGHLIGHT size=\"12\" id=\"account_no\" >";
echo "<td bgcolor=\"#66B463\">Issuing Date:<td bgcolor=\"#66B463\"><INPUT NAME=\"action_date\" TYPE=\"TEXT\" VALUE=\"\" $HIGHLIGHT size=\"12\" id=\"action_date\" >";
echo "<tr><td align=\"left\" bgcolor=\"#66B463\">Loan Type:<td bgcolor=\"#66B463\">";
makeSelect($shgl_type_array,'type','');
echo "<td bgcolor=\"#66B463\">Repay Period:<td bgcolor=\"#66B463\"><INPUT NAME=\"repay_date\" TYPE=\"TEXT\" VALUE=\"\" $HIGHLIGHT size=\"3\"> &nbsp; Months";
echo "<tr><td bgcolor=\"#66B463\">Due Interest Rate:<td bgcolor=\"#66B463\">Rs.&nbsp;<INPUT NAME=\"d_int_r\" TYPE=\"TEXT\" VALUE=\"10\" $HIGHLIGHT maxlength=\"5\" size=3>&nbsp;%";
echo "<td bgcolor=\"#66B463\">Over Due Interest Rate:<td bgcolor=\"#66B463\">Rs.&nbsp;<INPUT NAME=\"od_int_r\" TYPE=\"TEXT\" VALUE=\"11\" $HIGHLIGHT size=\"3\" maxlength=\"5\">&nbsp;%";
echo "<tr><td bgcolor=\"#66B463\">Issue Amount:<td bgcolor=\"#66B463\">Rs.&nbsp;<INPUT NAME=\"issued_amount\" TYPE=\"TEXT\" VALUE=\"\" $HIGHLIGHT size=10>";
echo "<td align=\"RIGHT\" bgcolor=\"#66B463\" colspan=\"2\"><input type=\"SUBMIT\" VALUE=\"    Go   \" >";
echo "</FORM>";
    }
}
