...
if(pg_NumRows($result)>0){
	$color="GREEN";
	echo "<tr><th bgcolor=YELLOW colspan=\"10\">SHG Loan Details of [$account_no] as on ".$action_date."</th>";
	echo "<tr>";
...
echo "<tr><th bgcolor=\"#DF7679\" colspan=\"4\"><font size=+2>SHG Loan Repayment Form of [$account_no]</font>";
echo "<FORM NAME=\"orderform\" method=\"POST\" action=\"loan_repayment.php?menu=$menu&op=i&ln_sl=$ln_sl&loan_no=$account_no&id=$id\" onSubmit=\"return varify();\">";
...
//echo $sql_statement;
	...
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','28101',$re_tot_amt,'Dr','SHG Loan Repay')";
	...
	$result=dBConnect($sql_statement);
		...
		echo "<div class='failed'><h3><font color=\"white\">Failed to update database.</font></h3></div>";
			...
			echo "</font></pre>";
			echo "<br><font size=+2><a href=\"../main/set_account.php?menu=$menu&account_no=$group_no\">Click</a> here to go Statement</div>"; 
		}
 	}
    }
}
