...
if(pg_NumRows($result)>0){
	...
	echo "<td align=right bgcolor=$color>".(float)$row['due_int']."</td>";
	echo "<td align=right bgcolor=$color>".(float)$row['overdue_int']."</td>";
	echo "<td align=right bgcolor=$color>".(float)($row['principal']+$row['due_int']+$row['overdue_int'])."</td>";
 ...
 echo "<br><h1><font color=RED><center>Your dont have any SMP Loan for Payment!!!!!!!!!!!</h1></center>";
    }
}
//==================================FOR REPAY FORM=========================================
if($op=='r'){
...
echo "<tr><td>Due Int.:<td>Rs.&nbsp;<INPUT NAME=\"d_i\" TYPE=\"TEXT\" VALUE=\"0\" $HIGHLIGHT size=5 >";
echo "<td>Over Due Int.:<td>Rs.&nbsp;<INPUT NAME=\"od_i\" TYPE=\"TEXT\" VALUE=\"0\" id=\"\" $HIGHLIGHT size=\"10\">";
...
if(empty($fy)){
	...
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','28101',$amount,'Dr','smp repay')";
	if($r_i_od>0){
