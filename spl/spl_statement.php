...
if($flag==1){
$sql_statement="SELECT * FROM  loan_statement where account_no='$account_no' AND action_date<=current_date ORDER BY loan_serial_no,entry_time DESC";
//echo $sql_statement;
...
if($j==0){
	...
	$ocrop=$row['loan_serial_no'];
}
if(strcmp($ocrop,$row['loan_serial_no'])){
	echo "<tr><td colspan=13 bgcolor=\"YELLOW\" align='center'><b>".getInterestRate($row['loan_serial_no'])."</td></tr>";
	$ocrop=$row['loan_serial_no'];
}
