...
$sql_statement="SELECT account_no, sum(amount) AS total_int FROM sb_detail_view WHERE particulars='int.' AND action_date BETWEEN '$starting_date' AND '$ending_date' GROUP BY account_no ORDER BY  account_no";
