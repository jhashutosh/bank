...
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"sb_closing_account.php?menu=$menu\">";
...
$sql_statement="SELECT * FROM customer_closing_sb WHERE closing_date BETWEEN '$starting_date' AND '$ending_date'";
