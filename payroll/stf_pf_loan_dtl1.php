...
//alert("years"+years);
var amount=document.getElementById('ac_am').value;
var rate=document.getElementById('d_int').value;
var due_int=Math.round((amount*rate*years)/100);
document.getElementById('d_int_am').value=due_int;
...
var amount=document.getElementById('ac_am').value;
//alert(amount);
var ap_amount=document.getElementById('ap_am').value;
//alert(ap_amount);
var lac_no=document.getElementById('pf_loan_ac_no').value.length;
//alert(ac_no);
         if(lac_no==0)
       {
...
echo"<tr><th colspan='9' bgcolor='CC3333' align='center'><font color='white' size='2'>STAFF PF LOAN DETAIL</font></th></tr><tr><td  colspan='9'></td></tr><tr><td  colspan='9'></td></tr><tr><td  colspan='9'></td></tr>";
echo"<tr><td colspan='9' align='right'><font size='0' color='red'>** if You don't find Your Employee Id in the Drop Down ,You are not a MEMBER </td></tr>";
echo"<tr><td align='left'> Employee ID  </td><td width='1%'>:</td><td>";makeselectemploan('id',"onChange=\"f2(this.value);\"");
...
echo "&nbsp<input type=\"button\" name=\"caldate\" value=\"...\" onclick=\"showCalendar(f1.ln_dt,'mm/dd/yyyy','Choose Date')\">&nbsp;Month/Date/Year </td>";
echo"<td>Period for loan (in months)</td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"mnth\" id=\"mnth\" size=\"3\" value=\"36\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\"  $HIGHLIGHT></td>";
echo"<td>Loan Repay Date</td><td width='1%'>:</td><td><input type=\"TEXT\" name=\"ln_rp_dt\" id='ln_rp_dt' size=\"11\" value=\"\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\"  $HIGHLIGHT> </td></tr><tr>";
//echo "&nbsp<input type=\"button\" name=\"caldate\" value=\"...\" onclick=\"showCalendar(f1.rp_dt,'dd/mm/yyyy','Choose Date')\"></td></tr><tr>";
echo"<td> Applied Amount</td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"ap_am\" id=\"ap_am\" size=\"7\" $HIGHLIGHT>";
echo"<td> Actual Amount</td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"ac_am\" id=\"ac_am\" size=\"7\" value=\"\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\" $HIGHLIGHT></td></tr><tr>";
...
echo"<td> Total Due Interest Amount  </td><td width='1%'>:</td><td><input type=\"TEXT\" name=\"d_int_am\" id=\"d_int_am\"size=\"5\" value=\"\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\"  $HIGHLIGHT></td></tr>";
//echo"<td align='right' >";
