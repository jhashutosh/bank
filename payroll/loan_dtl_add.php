...
//emp_pf_loan_hrd
$sql_statement="INSERT INTO emp_pf_loan_hrd (emp_id,pf_loan_ac_no,loan_date,repay_date,fy,applied_amt,actual_amt,int_due_rate,tot_due_int_amt, period,operator_code ,entry_time,b_principal,instalment_amt)VALUES
					   ($emp_id,'$loan_ac_no','$loan_date','$repay_date','$fy',$applied_amt,$loan_amount,$due_interest_rate,$tot_due_int_amt,$period,'$staff_id',now(),$loan_amount,$inst_amt)";
//gl_ledger_hrd
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type,action_date,certificate_no,fy,operator_code,entry_time)VALUES('$t_id','pfl','$loan_date','$loan_ac_no','$fy','$staff_id',now())";
//gl_ledger_dtl
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,account_no,amount,dr_cr, particulars) VALUES('$t_id','$gl_code','$loan_ac_no',$loan_amount,'Dr','pf loan')";
