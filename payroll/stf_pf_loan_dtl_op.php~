...
if(document.getElementById('ln_dt').value.length>0)
...
//echo $loan_date;
echo"<form  name='f1' action='loan_dtl_op_add.php' method='post' onsubmit='return amt_val(this.form);' >";
...
echo"<td> Actual Amount</td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"ac_am\" id=\"ac_am\" size=\"7\" value=\"\" onclick=\"cal_int()\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\"  $HIGHLIGHT></td>";
echo"<td> Balance Amount</td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"bal_am\" id=\"bal_am\" size=\"7\" value=\"\" $HIGHLIGHT></td></tr>";
echo"<tr><td> Due Interest Rate </td><td width='1%'>:</td><td> <input type=\"TEXT\" name=\"d_int\" id=\"d_int\" size=\"3\" value=\"10\" onfocus=\"cal_int()\"onChange=\"cal_int()\" onKeyup=\"cal_int()\"  $HIGHLIGHT>&nbsp;%";
