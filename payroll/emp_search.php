...
echo"<form action='sas.php' target='content'>";
...
echo"</select>";
echo"</td></tr>";
echo"<tr><td align=\"left\">Employee Name:</td></tr><tr><td><input type='text' name=\"name\" id=\"name\" size='10' onkeyup=\"showHint(this.value)\"  $HIGHLIGHT ><label align=\"left\"></label></td></tr>";
