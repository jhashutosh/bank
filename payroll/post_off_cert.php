...
echo"<td><input type='hidden' name='crt_s_n' size='7' value=\"$saving_regno/\" style='border-right:0px;' >$saving_regno/&nbsp;<input type='text' id='crt_n'  name='crt_n' style='border-left:0px;' size='2' ></td>";
