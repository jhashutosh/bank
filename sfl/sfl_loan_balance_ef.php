...
//general ledger posting
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks, operator_code, entry_time) VALUES ('$t_id','sfl','$curr_date','$fy','$remarks', '$staff_id', CAST('$curr_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
		
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','$account_no','$gl_code_loan',$balance_p,'Dr','opening SFL')";
...
echo "<FORM NAME=\"f1\" method=\"POST\" action=\"sfl_loan_balance_ef.php?menu=$menu&op=i\">";
...
echo "<tr><td>Due Interest Rate:<td>Rs.&nbsp;<INPUT NAME=\"d_int_r\" TYPE=\"TEXT\" VALUE=\"6\" $HIGHLIGHT maxlength=\"2\" size=3>&nbsp;%";
echo "<td>Over Due Interest Rate:<td>Rs.&nbsp;<INPUT NAME=\"od_int_r\" TYPE=\"TEXT\" VALUE=\"6\" $HIGHLIGHT size=\"3\" maxlength=\"2\">&nbsp;%";
