...
if($load_status=='o'){$URL='lad_loan_balance_ef.php?menu=lad&action_date='.$entry_date;}
else{$URL='lad_loan_issue_ef.php?menu=lad&action_date='.$entry_date;}
echo "<html>";
echo "<head>";
echo "<title>Security Deposit for LAD [$account_no]</title>";
...
URL="../lad/addDocument.php?menu=lad&account_no="+str+"&loan_sl_no="+mnu;
//alert(URL)
