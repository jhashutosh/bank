...
//gl_ledger_hrd
$sql_statement=$sql_statement."INSERT INTO gl_ledger_hrd (tran_id,type,action_date, certificate_no,fy,operator_code,entry_time)VALUES ('$t_id','$menu','$opening_date', '$certificate_no','$fy1','$staff_id',CAST('$opening_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP));";
$amount=$amount_deposit+$penalty;
$sql_statement=$sql_statement."INSERT INTO gl_ledger_dtl (tran_id,gl_mas_code,amount,dr_cr, particulars) VALUES ('$t_id','28101',$amount,'Dr','cash');";
...
if($penalty>0){
$sql_statement=$sql_statement."INSERT INTO gl_ledger_dtl (tran_id,account_no,gl_mas_code,amount, dr_cr, particulars) VALUES ('$t_id','$account_no','57915',$penalty,'Cr','penalty')";
$sql_statement=$sql_statement.";INSERT INTO rd_fine VALUES('$t_id','$account_no','$opening_date',$penalty)";
}
