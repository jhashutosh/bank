...
<html>
<head>
<title>RI Renewal</title>
<link rel="stylesheet" type="text/css" href="../css/test.css" />
</head>
<body bgcolor="silver" onload="withdrawal_date.focus();">

<?php
$sql1="SELECT (CURRENT_DATE-maturity_date) as days  FROM deposit_info WHERE account_no='$account_no' and account_type='ri' and withdrawal_type is null";
...
<input type="hidden" name="prin_int" id="prin_int" size="7" value="<?echo $principal+$interest?>">
	...
	<tr>
		...
		<td>
			<input type="TEXT" name="period" id="period" size="3" <? echo$HIGHLIGHT?>> Months
