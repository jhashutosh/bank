...
{
 echo "<form method=\"POST\" action=\"ri_ledger_wvf.php?menu=$menu\">";
 echo "<table bgcolor=#3CB371 align=center width=70%>";
...
//********************************************************************************************************/
 echo "<tr><td><td><td><td align=\"right\"><input type=\"SUBMIT\" name=\"SUBMIT_BUTTON\" value=\" Withdrawal\">";
echo "</table>";
echo "</form>";
 }
}
