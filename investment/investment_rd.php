...
$flag=1;
if($flag==1){
$sql_statement="SELECT * FROM bk_investment where  withdrawal_date is null and account_type='rd'";
//echo $sql_statement;
...
echo "<tr><td bgcolor=\"BLUE\" colspan=\"10\" align=\"center\"><font color=\"white\"><B>SASATI S.K.U.S LTD.<B></font><font size=+1 color=\"white\"></font>";
echo "<tr><td bgcolor=\"BLUE\" colspan=\"10\" align=\"center\"><font color=\"white\"><B>SASATI****HOWRAH<B></font><font size=+1 color=\"white\"></font>";
$color="GREEN";
echo "<tr>";
