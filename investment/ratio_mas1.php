...
echo"<input type=\"TEXT\" name=\"rto_nm\" size=\"8\" value=\"\"  $HIGHLIGHT>";
echo"</td>";
...
echo"</select></td></tr>";
echo"<tr><td align='right' colspan=\"1\" ><font color='black' size='2'>Derived</font></td><td align='left' colspan=\"1\"><input type=\"checkbox\" name=\"drvd\" id=\"drvd\" style=\"width:55px;height:60px\"></td>";
