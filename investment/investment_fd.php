...
$flag=1;
if($flag==1){
$sql_statement="SELECT * FROM bk_investment where  withdrawal_date is null and account_type='fd'";
//echo $sql_statement;
...
echo "<tr><td bgcolor=\"BLUE\" colspan=\"9\" align=\"center\"><font color=\"white\"><B>$PROJECT_TITLE<B></font><font size=+1 color=\"white\"></font>";
echo "<tr><td bgcolor=\"BLUE\" colspan=\"9\" align=\"center\"><font color=\"white\"><B><B></font><font size=+1 color=\"white\"></font>";
$color="GREEN";
echo "<tr>";
