...
echo "</table></form>";
echo "<hr>";
$sql_statement="SELECT compute_main_deposit_pint1('fa','$ending_date') AS pint";
...
echo "<tr><td colspan=\"$cols\" align=center><iframe src=\"provisional_interest_fd_axis_db.php?menu=$menu\" width=\"100%\" height=\"300\" ></iframe>";
echo "<tr>";
$sql_statement="SELECT SUM(principal) AS p,COUNT(*) as c,SUM(interest) AS i FROM provissional_interest WHERE trim(deposit_type)='fa'";
$result=dBConnect($sql_statement);
//echo $sql_statement; 
