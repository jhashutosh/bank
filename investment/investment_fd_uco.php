...
$sql_statement="SELECT * FROM bk_investment where (withdrawal_date not in(select withdrawal_date FROM bk_investment where withdrawal_date<='$start_date') or withdrawal_date is null)and account_type='fd' and op_date<='$start_date'";
echo $sql_statement;
