...
if($flag==1){
echo "<hr>";
echo "<form method=\"POST\" name=\"f1\" action=\"fd_ledger_evf.php?menu=fd\" onSubmit=\"return varify_fd(this.form);\">";
echo "<table bgcolor=skyblue align=center width=90%>";
...
echo "<tr><td align=\"left\">Certificate no:<td><input type=\"TEXT\" name=\"certificate_no\" size=\"25\" value=\"$new_certificate_no\" id=\"c\" $HIGHLIGHT><br>";
