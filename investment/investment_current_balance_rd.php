...
echo "</table></form>";
echo "<hr>";
$sql_statement="SELECT * from bk_investment where account_type='rd'";
...
for($j=0; $j<pg_NumRows($result); $j++){
	...
	echo "<tr>";
	echo "<td align=Center bgcolor=$color><a href=\"../investment/statement.php?menu=$menu&account_no=".$row['account_no']."\" target=\"display\">".$row['account_no']."</a></td>";
if($menu!='rd' || $menu!='mis' ){
