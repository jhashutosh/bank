...
echo "<hr>";
echo "<form method=\"POST\" action=\"provisional_interest_ri.php?menu=$menu\">";
...
echo "</table></form>";
echo "<hr>";
$sql_statement="SELECT compute_main_deposit_pint1('ri','$ending_date') AS pint";
...
echo "<font size=\"+2\" color=\"GREEN\"><center>Total Receiveable Interest&nbsp;:&nbsp;&nbsp;<font color=\"BLUE\"<B>Rs.".amount2Rs($current_balance)."/=</B></font></font>";
...
if($menu!='rd'){
echo "<th bgcolor=$color width=\"15%\">Certificate No.</th>";
}
echo "<th bgcolor=$color width=\"25%\">Name</th>";
echo "<th bgcolor=$color width=\"15%\">Principal</th>";
echo "<th bgcolor=$color width=\"15%\">Maturity Date</th>";
echo "<th bgcolor=$color width=\"15%\">Interest</th>";
echo "<tr><td colspan=\"$cols\" align=center><iframe src=\"provisional_interest_db.php?menu=$menu\" width=\"100%\" height=\"300\" ></iframe>";
echo "<tr>";
$sql_statement="SELECT SUM(principal) AS p,COUNT(*) as c,SUM(interest) AS i FROM provissional_interest WHERE trim(deposit_type)='ri'";
$result=dBConnect($sql_statement);
//echo $sql_statement; 
