...
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr,particulars,cost_code) VALUES('$t_id','$account_no','$gl_code_int',$interest,'Cr','cash','cl')";
		...
		$sql_statement=$sql_statement.";UPDATE deposit_info set  withdrawal_date= '$withdrawal_date',withdrawal_type='Mature',withdrawal_amount='$with_amt',withdrawal_interest='$interest' where account_no='$account_no' and withdrawal_date IS NULL";
...
// for credit
$sql_statement=$sql_statement.";UPDATE deposit_info set  withdrawal_date= '$withdrawal_date',withdrawal_type='Mature',withdrawal_amount='$with_amt',withdrawal_interest='$int' where account_no='$account_no' and withdrawal_date IS NULL";
