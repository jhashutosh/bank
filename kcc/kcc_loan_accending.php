...
if($statement==ac){
echo "<center><tr><th bgcolor=green colspan=11><font color=white size=5>List Of KCC Loan According to Accending Order On A/C No</font></center>";
}
if($statement==amount){
echo "<center><tr><th bgcolor=green colspan=11><font color=white size=5>List Of KCC Loan According to Accending Order On Amount</font></center>";
}

$color="#F0E68C";
echo "<tr>";
echo "<th bgcolor=$color width=\"10%\" rowspan=\"2\">KCC A/C NO.</th>";
