...
if($load_status=='o'){$URL='pl_loan_balance_ef.php?menu=pl&action_date='.$entry_date;}
else{$URL='pl_loan_issue_ef.php?menu=pl&action_date='.$entry_date;}
echo "<html>";
echo "<head>";
...
URL="../pl/addDocument.php?menu=pl&account_no="+str+"&loan_sl_no="+mnu;
//alert(URL)
...
echo "&nbsp;<INPUT TYPE=\"button\" name=\"s1\" VALUE=\"...\" disabled onClick=\"openChild();\">";
