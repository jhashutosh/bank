...
if(pg_NumRows($result)>0){
	$color="GREEN";
	echo "<tr><th bgcolor=YELLOW colspan=\"9\">MT-Loan Details of [$account_no] as on ".date('d.m.Y')."</th>";
	echo "<tr>";
...
echo "<FORM NAME=\"pForm\" method=\"POST\" action=\"mtl_loan_repayment.php?menu=$menu&op=i&ln_sl=$ln_sl\" onSubmit=\"return cr_chk();\">";
...
*/
	...
	//For GL ENTRY-------------------------------------
	$sql_statement.=";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks, operator_code, entry_time) VALUES ('$t_id','mt','$action_date','$fy','$remarks','$staff_id',now())";
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','28101',$amount,'Dr','MT Repay')";
	if($r_i_od>0){
	...
	$sql_statement.=";UPDATE loan_security SET status='r' WHERE account_no='$account_no'";
