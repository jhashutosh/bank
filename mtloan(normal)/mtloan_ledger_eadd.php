...
//loan_ledger_hrd
$sql_statement="INSERT INTO loan_ledger_hrd (loan_serial_no,loan_type,customer_id,account_no,fy, issue_date,repay_date,period,int_due_rate,int_overdue_rate,applied_amount,payment_term,purpose, status,staff_id,gl_code,entry_time)VALUES('$loan_sl_no','$menu','$c_id','$account_no','$fy','$loan_date', '$repay_date',$period,$due_interest_rate,$overdue_interest_rate,$applied_amount,'$pay_term', '$purpose','op', '$staff_id','$gl_code',now())";
//loan_issue_dtl
...
//gl_ledger_hrd
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type,action_date,certificate_no,fy,remarks, operator_code,entry_time)VALUES('$t_id','$menu','$loan_date','$account_no','$fy','$purpose','$staff_id',now())";
//gl_ledger_dtl
