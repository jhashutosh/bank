...
// Loan_Ledger_Hrd
	$sql_statement="INSERT INTO loan_ledger_hrd(loan_serial_no,loan_type,customer_id,fy,account_no,issue_date,repay_date,int_due_rate, int_overdue_rate,status,gl_code,gl_status) VALUES ('$loan_sl_no','mt','$id','$fy1','$account_no','$action_date', '$repay_date',$due_int,$overdue_int,'op','$gl_code_loan','$gl_status')";
...
//general ledger posting
	//gl_ledger_hrd
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks, operator_code, entry_time) VALUES ('$t_id','mt','$curr_date','$fy1','$remarks', '$staff_id', CAST('$curr_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
//gl_ledger_dtl		
...
echo "<tr><th bgcolor=\"#006400\" colspan=\"4\"><font size=+2>MT-LOAN Issuing Form of [$account_no]</font>";
