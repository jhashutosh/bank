...
echo "<form method=\"POST\" name=\"parentForm\" action=\"ksloan_ledger_evf.php?menu=$menu\">";
echo "<table bgcolor=AQUA align=center width=80%>";
echo "<tr><TH colspan=5 bgcolor=BLUE><font color=WHITE size=+2><b>KS-Loan Issue Form[$account_no]";
...
echo "<tr><td align=\"left\">Interest Rate:<td><input type=\"TEXT\" name=\"interest_rate\" size=\"10\" value=\"11.5\" $HIGHLIGHT><td>";
echo "<td align=\"left\">Over DueInterest Rate:<td><input type=\"TEXT\" name=\"overdue_interest_rate\" size=\"10\" value=\"13.5\" $HIGHLIGHT><td>";
