...
//echo $sql_statement;
		...
		$balance=pg_result($result,'balance');
	 	...
	 	$balance=global_sb_current_balance($status);
		}
 	   }
	else{
		$balance=0;
...
echo "<tr><td colspan=\"3\" align=\"center\"><iframe src=\"sb_current_balance_tabular_db.php?status=$status&menu=$menu\" width=\"850\" height=\"310\" ></iframe></td></tr>";
echo "<tr>";
$color="cyan";
