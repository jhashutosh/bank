...
echo "<hr>";
echo "<form method=\"POST\" action=\"fd_mature_list.php?menu=$menu\" method=\"POST\" name=f1>";
...
echo "</table>";
echo "</form>";
$sql_statement="SELECT * FROM customer_fd WHERE withdrawal_type='Mature' and action_date BETWEEN '$starting_date' AND '$ending_date'";
...
echo "<tr><td bgcolor=\"green\" colspan=\"11\" align=\"center\"><font color=\"white\">Fixed Deposit Mature Account List Date in Between $starting_date and $ending_date</font>";
