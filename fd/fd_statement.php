...
echo "<h3>Account Statement of Fixed Deposit [$account_no]";
echo "</h3><hr>";
...
echo "<hr>";
// Ledger Section*/
//$sql_statement="SELECT * FROM customer_fd WHERE account_no='$account_no'";

$sql_statement="SELECT distinct customer_id,certificate_no,principal,period,maturity_amount,operator_code,date_with_effect,scheme,action_date,interest_rate ,
interest_method,maturity_date,withdrawal_type,entry_time,withdrawal_date,withdrawal_amount FROM customer_fd WHERE account_no='$account_no'";
//echo $sql_statement;
$result=dBConnect($sql_statement);
if(pg_NumRows($result)==0) {
echo "<h4>Not found!!!</h4>";
} else {
echo "<table valign=\"top\" width=\"90%\" class=\"border\">";
...
echo "<th bgcolor=$color>Fd compute type</th>";
