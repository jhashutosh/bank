...
echo "<hr>";
echo "<form method=\"POST\" action=\"fd_closing_account.php?menu=$menu\" method=\"POST\" name=f1>";
...
echo "<tr><td bgcolor=\"green\" colspan=\"11\" align=\"center\"><font color=\"white\">Fixed Deposit Closed Account List Date in Between $starting_date and $ending_date</font>";
