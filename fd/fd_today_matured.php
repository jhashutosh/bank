...
echo "<hr>";
echo "<form method=\"POST\" action=\"fd_today_matured.php?menu=$menu\" method=\"POST\" name=f1>";
...
echo "</table>";*/
echo "</form>";
$sql_statement="SELECT * FROM customer_fd WHERE maturity_date='$ending_date'";
...
echo "<tr><td bgcolor=\"green\" colspan=\"9\" align=\"center\"><font color=\"white\">Fixed Deposit Today Mature Account List Date in Between $starting_date and $ending_date</font>";
...
echo "<th  colspan=\"1\">Maturity Amount</th>";
