...
echo "<h1><center><b>You Can't Insert any value Into database Because Financial Year already Locked by administrator !!!!!!!!!";
	...
	//echo "fy=$fy";
	 ...
	 $sql_statement="INSERT INTO gl_ledger_hrd (tran_id,type,action_date,certificate_no,fy,remarks, operator_code, entry_time,cheque_no,cheque_dt) VALUES ('$t_id','fd','$withdrawal_date','$certificate_no','$fy','$remarks','$staff_id', now(),'$ch_no','$cheque_dt')";
...
('$t_id','$gl_code_s',upper('$sb_ac'),$with_val,'Cr','Paid To $account_no')";
		 $insert_flag=true;
