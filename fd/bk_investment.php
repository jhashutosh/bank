...
echo "<tr><th colspan=\"7\" bgcolor=\"blue\"><font color=white size=5>Create New Investment In Bank</font></th>";
/*echo "<tr>";
echo "<td bgcolor=\"lightblue\">Type of :<td bgcolor=\"lightblue\">";
makeSelectwithJS($bk_type_array,'type_of',"","type_of","onchange=\"f2(this.value);\"");
echo "<td bgcolor=\"lightblue\">Account Type:<td bgcolor=\"lightblue\">";
...
echo "<td bgcolor=\"lightblue\">Investment Catagory:<td bgcolor=\"lightblue\">";
//makeSelectDisabled($ccb_loan_array,'gl_code',"");*/
?>
<span id="txtHint"></span>
<?php
echo "<tr>";
//echo "<td bgcolor=\"lightblue\">Bank Name:<td bgcolor=\"lightblue\"><input type=TEXT name=\"bank_name\" size=\"15\" $HIGHLIGHT>";
//echo "<td bgcolor=\"lightblue\">Branch Name:<td bgcolor=\"lightblue\"><input type=TEXT name=\"branch_name\" size=\"15\" $HIGHLIGHT>";
echo "<td bgcolor=\"lightblue\">Opening Date:<td bgcolor=\"lightblue\"><input type=TEXT name=\"op_date\" size=\"10\" VALUE=\"".date('d.m.Y')."\" $HIGHLIGHT>";


echo "<td bgcolor=\"lightblue\">Account No:<td bgcolor=\"lightblue\"><input type=TEXT name=\"account_no\" size=\"12\" $HIGHLIGHT>";
echo "<tr>";
echo "<td bgcolor=\"lightblue\">Certificate No:<td bgcolor=\"lightblue\"><input type=TEXT name=\"cer_no\" size=\"12\" $HIGHLIGHT>";
echo "<td bgcolor=\"lightblue\">Principal:&nbsp;(Rs.)<td bgcolor=\"lightblue\"><input type=TEXT name=\"principal\" size=\"12\" $HIGHLIGHT>";


echo "<tr>";
echo "<td bgcolor=\"lightblue\">Maturity Date <td bgcolor=\"lightblue\"><input type=TEXT name=\"mat_dt\" size=\"12\" $HIGHLIGHT>";
echo "<td bgcolor=\"lightblue\">Rate of Interest:<td bgcolor=\"lightblue\"><input type=TEXT name=\"int_rate\" size=\"5\" $HIGHLIGHT> &nbsp;(%)";
echo "<tr>";
echo "<td bgcolor=\"lightblue\">Maturity Amount:&nbsp;(Rs.)<td bgcolor=\"lightblue\"><input type=TEXT name=\"mat_amt\" size=\"12\" VALUE=\"\" $HIGHLIGHT>";

/*echo "<tr>";
echo "<td bgcolor=\"lightblue\">Payment Mode:<td bgcolor=\"lightblue\">";
makeSelectwithJS($mode_array,'p_mode',"","p_mode","onchange=\"f3(this.value);\"");
echo "<td bgcolor=\"lightblue\">Cheque No:<td bgcolor=\"lightblue\"><input type=TEXT name=\"ch_no\" size=\"12\" id=\"ch_no\" value=\"0\" disabled $HIGHLIGHT>";
echo "<td bgcolor=\"lightblue\">Transfer From<td bgcolor=\"lightblue\">";
selectBankAccount('bank_ac_no','DISABLED');*/

echo "<td bgcolor=\"lightblue\">Remarks:<td colspan=2 bgcolor=\"lightblue\" valign=\"center\"><textarea name=\"remarks\" rows=\"2\" cols=\"80\" id=\"rm\" $HIGHLIGHT></textarea>";
...
//--------------------Display
/*$sql_statement="SELECT * FROM bank_bk_dtl WHERE (account_type<>'$menu') AND status='op'";
//echo "$sql_statement";
$result=dBConnect($sql_statement);
...
echo "<tr bgcolor=GREEN><th>Sl No.<th>A/C No.<th>Bank Name<th>Balance<th>Operation";
	...
	$sql1="SELECT maturity_date as unmtr_dt FROM bk_investment WHERE account_no='".$row['account_no']."' and account_type='ri' and withdrawal_type is null";
	$res=dBConnect($sql1);
	$row1=pg_fetch_array($res,0);
	$unmtr_dt=$row1['unmtr_dt'];
	//echo $sql1;
...
///////////////update////////////////////////////////
		...
		if(date('d/m/y')>=$unmtr_dt)
		{//echo $unmtr_dt;
			echo "&nbsp;||&nbsp;<a  href=\"\" onClick=\"javascript:alert(\"It is a unmature amount\");\">Renewal</a>";
		}
		else
		{//echo $unmtr_dt;
