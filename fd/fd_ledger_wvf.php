...
//alert(str)
if(str=='n'){
document.form.sb_ac.value='';
document.form.sb_ac.disabled=true;
document.form.sb_bt.disabled=true;
}
else{
//alert('h')
document.form.sb_ac.disabled=false;
document.form.sb_ac.READONLY=false;
document.form.sb_bt.disabled=false;
document.form.sb_ac.focus();
...
else 
{
  ...
  $sql_statement="SELECT withdrawal_fd('$account_no','$certificate_no','$withdrawal_date');";
...
echo "<form method=\"POST\" action=\"fd_ledger_wadd.php?menu=$menu\">";
echo "<table bgcolor=#7FFFD4 align=center width=90% class=\"b\">";
...
echo "<tr><td align=\"left\">Withdrawn Type:<td><input type=\"TEXT\" name=\"withdrawal_type\" size=\"15\" value=\"$maturity_type\" readonly $HIGHLIGHT><br>";
