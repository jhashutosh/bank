...
echo "<form name=\"f1\" action=\"npa_od_dtl.php?menu=$menu\" method=\"POST\" onsubmit=\"return check();\">";
...
$id=$row['customer_id'];
echo "<td bgcolor=\"$color\">".$loan_module_array[trim($row['loan_type'])];
...
echo "<td bgcolor=\"$color\" align=\"right\">".$row['date_of_npa'];
