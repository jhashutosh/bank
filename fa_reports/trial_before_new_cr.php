...
echo "<tr>";
echo "<th bgcolor=$color colspan=\"7\"><font size='2'>Cash Cum Trial Balance (Before) -Cr as on : $start_date </font></th></tr>";
echo "<tr>";
echo "<th bgcolor=$color colspan=\"1\" width=\"8%\" >Code</th>";
echo "<th bgcolor=$color colspan=\"1\" width=\"37%\">Account Name</th>";
echo"<th bgcolor=$color colspan=\"1\" width=\"16%\">Opening Balance Cr.</th>";
echo "<th bgcolor=$color colspan=\"1\" width=\"10%\" >Debit(-)</th>";
echo "<th bgcolor=$color colspan=\"1\" width=\"10%\" >Credit(+)</th>";
echo "<th bgcolor=$color colspan=\"1\" width=\"10%\" >Balance</th></tr>";
