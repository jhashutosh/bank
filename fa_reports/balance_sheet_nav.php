...
echo "</tr>";
//------------------------------------------------------------OTHERS LOANS------------------------------
$sql_statement=" select (dr-cr) as p_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<=date('$start_date')-INTERVAL '1 year' and (gl_mas_code='23591' or gl_mas_code='23592' or gl_mas_code between  '23107' and '23112' or gl_mas_code='23600')) as foo"; 
...
$sql_statement=" select (dr-cr) as c_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<='$start_date' and action_date>='$f_start_dt' and (gl_mas_code='23591' or gl_mas_code='23592' or gl_mas_code between  '23107' and '23112' or gl_mas_code='23600')) as foo"; 
...
$sql_statement=" select (dr-cr) as p_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<=date('$start_date')-INTERVAL '1 year' and (gl_mas_code='26101' or gl_mas_code='26102') ) as foo"; 
...
$sql_statement=" select (dr-cr) as c_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<='$start_date' and action_date>='$f_start_dt' and (gl_mas_code='26101' or gl_mas_code='26102') ) as foo"; 
...
$sql_statement=" select (dr-cr) as p_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<=date('$start_date')-INTERVAL '1 year' and  (gl_mas_code between '27101' and '27139' or gl_mas_code='27140' or gl_mas_code='27171' or gl_mas_code='27150' or gl_mas_code='27190')) as foo"; 
...
$sql_statement=" select (dr-cr) as c_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<='$start_date' and action_date>='$f_start_dt' and (gl_mas_code between '27101' and '27139' or gl_mas_code='27140' or gl_mas_code='27171' or gl_mas_code='27150' or gl_mas_code='27190')) as foo"; 
...
$sql_statement=" select (dr-cr) as p_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<=date('$start_date')-INTERVAL '1 year' and (gl_mas_code between  '27201' and '27211')) as foo"; 
...
$sql_statement=" select (dr-cr) as c_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<='$start_date' and action_date>='$f_start_dt' and (gl_mas_code between  '27201' and '27211')) as foo"; 
