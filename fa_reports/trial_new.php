...
echo "<td bgcolor=$color colspan=\"1\" width=\"8%\" ><a href=\"gl_ledger.php?chead=".$row['gl_mas_desc']."[".$row['gl_mas_code']."]&gl_code=".$row['gl_mas_code']."&start_date=$f_start_dt&end_date=$end_date&status=1"."\" onClick=\"window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=150,left=350, width=700,height=300'); return false;\">".$row['gl_mas_code']."</a></td>";
