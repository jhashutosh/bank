...
echo"<tr><th colspan=\"6\" bgcolor='aqua' align='center'>".$desc."[".$code."]</th></tr>";
echo "<tr><th bgcolor=$color colspan=\"1\" width=\"10%\">Account No</th>";
...
for($j=0; $j<pg_NumRows($result); $j++){
	...
	echo "<tr>";
	echo "<td align=left width=\"10%\" bgcolor=$color><a href=\"a_bal_brkup_brkup_brkup.php?id=".$row[0]."&desc=".$row[0]."\" onClick=\"window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=150,left=350, width=700,height=300'); return false;\">".$row[0]."</a>";
	//echo "<td width=\"10%\"  bgcolor=$color>".$row[1]."</td>";
	echo "<td align=right width=\"15%\"  bgcolor=$color>".amount2Rs($row[1])."</td>";
	...
	//echo "<td align=right width=\"15%\"  bgcolor=$color>".amount2Rs(abs($row[4]))."</td>";
