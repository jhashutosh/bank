...
SELECT gl_mas_code,SUM(gl_mas_bl_prv),0,SUM(dr_amt) as dr,SUM(cr_amt) as cr,SUM(dr_amt-cr_amt+gl_mas_bl_prv) as dr_bal,0 FROM sch_bs_sh_gm WHERE fn_nm IN ('bs_sch','P/L') AND (CAST(gl_mas_code AS INT) BETWEEN 20000 AND 39999 OR CAST(gl_mas_code AS INT) BETWEEN 60000 AND 79999) GROUP BY gl_mas_code 
