...
//----------------------------------------------------------CASH IN HAND------------------------------
$sql_statement=" select (cr-dr) as p_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<=date('$start_date')-INTERVAL '1 year' and (gl_mas_code='28101' or gl_mas_code='28102')) as foo"; 
