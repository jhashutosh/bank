...
//--------------------------------------------------------------------------------------------
$sql_statement="SELECT a.gl_mas_code,initcap(a.gl_mas_code), b.gl_mas_desc, SUM(op_bal) as op_bal, SUM(curr_debit) as  curr_debit, SUM(curr_credit) as curr_credit, SUM(curr_bal) as curr_bal, SUM(cl_bal_debit) as cl_bal_debit, SUM(cl_bal_credit) as cl_bal_credit FROM ( 
