...
$sql_statement=" select (cr-dr) as c_cr from (select sum(credit) as cr,sum(debit) as dr from mas_gl_tran where action_date<='$start_date' and action_date>='$f_start_dt' and gl_mas_code in('11200','11201')) as foo"; 
