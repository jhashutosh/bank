...
echo "<hr>";
//-------------------------------------------------------------------------------------------
$sql_statement="truncate table loan_cal_int;truncate table loan_cal_int1;truncate table loan_cal_int2;truncate table loan_cal_int3;truncate table loan_cal_int4;SELECT loan_calculation('ccl','$end_date') as int;";
$sql_statement.="insert into loan_cal_int1  select * from loan_cal_int;";  
$sql_statement.="truncate table loan_cal_int;SELECT loan_calculation('kcc','$end_date') as int;"; 
$sql_statement.="insert into loan_cal_int2  select * from loan_cal_int;"; 
$sql_statement.="truncate table loan_cal_int;SELECT loan_calculation('mt','$end_date') as int;"; 
$sql_statement.="insert into loan_cal_int3  select * from loan_cal_int;"; 
$sql_statement.="truncate table loan_cal_int;SELECT loan_calculation('shg','$end_date') as int;"; 
$sql_statement.="insert into loan_cal_int4  select * from loan_cal_int;"; 
$sql_statement.="
select b.loan_type,a.loan_amount,b.standard,b.sub,b.d1,b.d2,b.d3,b.unsecured_asset,b.loss_asset,b.balance_principal,b.due_int,b.overdue_int from
(select 'ccl' as loan_type,sum(a.amount) as loan_amount from gl_ledger_dtl a,gl_ledger_hrd b where a.gl_mas_code in('23115','23116') and a.dr_cr='Dr' and a.tran_id=b.tran_id and b.action_date<='$end_date') a,   
(SELECT loan_type,round(SUM(issue_amount)) AS loan_amount,round(SUM(standard)) AS standard,round(SUM(sub)) AS sub,round(SUM(d1)) AS d1,round(SUM(d2)) AS d2,round(SUM(d3)) AS d3,round(SUM(unsecured_asset)) AS unsecured_asset,round(SUM(loss_asset)) AS loss_asset,SUM(balance_principal) AS balance_principal,SUM(due_int) AS due_int,SUM(overdue_int) AS overdue_int FROM npa_vw1 GROUP BY loan_type) b where b.loan_type::bpchar=a.loan_type::bpchar

UNION ALL
select b.loan_type,a.loan_amount,b.standard,b.sub,b.d1,b.d2,b.d3,b.unsecured_asset,b.loss_asset,b.balance_principal,b.due_int,b.overdue_int from
(select 'kcc' as loan_type,sum(a.amount) as loan_amount from gl_ledger_dtl a,gl_ledger_hrd b where a.gl_mas_code in('23103','23104') and a.dr_cr='Dr' and a.tran_id=b.tran_id and b.action_date<='$end_date') a,   
(SELECT loan_type,round(SUM(issue_amount)) AS loan_amount,round(SUM(standard)) AS standard,round(SUM(sub)) AS sub,round(SUM(d1)) AS d1,round(SUM(d2)) AS d2,round(SUM(d3)) AS d3,round(SUM(unsecured_asset)) AS unsecured_asset,round(SUM(loss_asset)) AS loss_asset,SUM(balance_principal) AS balance_principal,SUM(due_int) AS due_int,SUM(overdue_int) AS overdue_int FROM npa_vw2 GROUP BY loan_type) b where b.loan_type::bpchar=a.loan_type::bpchar

UNION ALL
select b.loan_type,a.loan_amount,b.standard,b.sub,b.d1,b.d2,b.d3,b.unsecured_asset,b.loss_asset,b.balance_principal,b.due_int,b.overdue_int from
(select 'mt' as loan_type,sum(a.amount) as loan_amount from gl_ledger_dtl a,gl_ledger_hrd b where a.gl_mas_code in('23207','23208') and a.dr_cr='Dr' and a.tran_id=b.tran_id and b.action_date<='$end_date') a,   
(SELECT loan_type,round(SUM(issue_amount)) AS loan_amount,round(SUM(standard)) AS standard,round(SUM(sub)) AS sub,round(SUM(d1)) AS d1,round(SUM(d2)) AS d2,round(SUM(d3)) AS d3,round(SUM(unsecured_asset)) AS unsecured_asset,round(SUM(loss_asset)) AS loss_asset,SUM(balance_principal) AS balance_principal,SUM(due_int) AS due_int,SUM(overdue_int) AS overdue_int FROM npa_vw3 GROUP BY loan_type) b where b.loan_type::bpchar=a.loan_type::bpchar

--UNION ALL
--select b.loan_type,a.loan_amount,b.standard,b.sub,b.d1,b.d2,b.d3,b.unsecured_asset,b.loss_asset,b.balance_principal,b.due_int,b.overdue_int from
--(select 'shg' as loan_type,sum(a.amount) as loan_amount from gl_ledger_dtl a,gl_ledger_hrd b where a.gl_mas_code in('23213','23214') and a.dr_cr='Dr' and a.tran_id=b.tran_id and 
-- b.action_date<='$end_date') a,   
--(SELECT loan_type,round(SUM(issue_amount)) AS loan_amount,round(SUM(standard)) AS standard,round(SUM(sub)) AS sub,round(SUM(d1)) AS d1,round(SUM(d2)) AS d2,round(SUM(d3)) AS d3,
--round(SUM-(unsecured_asset)) AS unsecured_asset,round(SUM(loss_asset)) AS loss_asset,SUM(balance_principal) AS balance_principal,SUM(due_int) AS due_int,SUM(overdue_int) AS overdue_int FROM
-- npa_vw4 GROUP BY loan_type) b where b.loan_type::bpchar=a.loan_type::bpchar
";

//$sql_statement.="select round(SUM(due_int)) as d,round(SUM(overdue_int)) as o,round(SUM(principal)) as p from loan_cal_int WHERE status='d' OR status='o' and loan_type like 'ccl'";
if($menu!='all'){
