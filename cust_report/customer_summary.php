...
$jn=$row['jn'];
if($jn==""){$jn=0;}
$sql_statement="SELECT count(*) as nr FROM customer_master where type_of_customer='nr'";
$result=dBConnect($sql_statement);
$row=pg_fetch_array($result);
$nr=$row['nr'];
if($nr==""){$nr=0;}
...
echo "<tr><th width=22% bgcolor=white><font color=green>Sole Account Record</th>
<th width=22% bgcolor=white><font color=green>$so</th>
<th width=22% bgcolor=white><font color=green>NREGS Account Record</th>
<th width=22% bgcolor=white><font color=green>$nr</th>";
echo "<tr><th width=22% bgcolor=white ><font color=green>Organizational Account Record</th>
<th width=22% bgcolor=white><font color=green>$or</th>
<th width=22% bgcolor=white><font color=green>Joint Account Record</th>
<th width=22% bgcolor=white><font color=green>$jn</th>";
echo "<tr><th width=22% bgcolor=white><font color=green>Group Account Record</th>
<th width=22% bgcolor=white><font color=green>$gp</th>
<th width=22% bgcolor=white><font color=green>No of Member Record</th>
<th width=22% bgcolor=white><font color=green>$member</th>";
echo "</table>";
...
$sql_statement="SELECT * FROM customer_master  order by type_of_customer";
