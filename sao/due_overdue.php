...
echo "<hr>";
echo "<form name=\"frm1\" method=\"post\" action=\"due_overdue.php?menu=sao&op=i\">";
echo "<table align=\"center\" width=\"90%\">";
echo "<tr>";
echo "<td bgcolor=\"green\" colspan=\"3\" align=\"center\"><font color=\"white\" size=\"5\"><b>Due & Overdue Entry Form</b></font>";
echo "<tr>";
$color="#CCCC2222";
echo "<th bgcolor=$color width=30% rowspan=\"1\">SAO A/C No:&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"text\" id=\"txt1\" name=\"text1\" value=\"$account_no\" size=\"15\" $HIGHLIGHT></th>";
...
$t_id=getTranId();
$sql_statement="INSERT INTO sao_op_bal_entry(account_no,tran_id,issue_date,repay_date,last_repayment_date,last_int_date,due_principal,due_int,overdue_int,loan_amount,due_int_rate,
