...
$l_name='SAO';
$status='sao';
$i_page="../sao/sao_loan_issue.php?menu=sao&account_no=$account_no";
$r_page="../sao/sao_loan_repayment.php?menu=sao&account_no=$account_no";
$s_page="../sao/sao_loan_statement.php?menu=sao&op=i&account_no=$account_no";
/*
if(!empty($account_no)){
...
echo "<form action=\"sao_loan_main.php\">";
