...
$color="#CCCC00";
echo "<tr>";
echo "<th colspan=\"12\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Due List Of SAO Loan";
echo "<tr>";
...
$action_date=getActionDate($sao_account_no);
echo "<th bgcolor=$color>$action_date</th>";
$amount=getSaoLoanAmount($sao_account_no);
//$action_date=getSaoLoanAmount($sao_account_no);
...
$rep_date=getSaoRepaymentDate($sao_account_no);
...
$color="#CCCC5555";
echo "<tr>";
echo "<th colspan=\"12\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Personal Statement Of SAO -- KALNA II CADP";
echo "<form name=\"form1\" method=\"post\" action=\"../sao/duelist_report.php?state=p&op=s&account_no=$account_no\">";
echo "<th colspan=\"12\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Account No:<input type=\"text\" name=\"txt1\" value=\"SAO-\">&nbsp;&nbsp;<input type=\"submit\" value=\"Enter\" name=\"button1\">";
...
//--------------------------Daily SAO loan repayment List---------------------------
if($statement==dr)
{
echo "<table bgcolor=\"silver\" width=\"100%\" align=\"center\">";
$color="#CCCC0000";
echo "<tr>";
echo "<th colspan=\"13\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Daily SAO Loan Repayment List--Date:";
echo "<tr>";
echo "<th rowspan=\"2\" bgcolor=\"$color\">Time</th>";
echo "<th rowspan=\"2\" bgcolor=\"$color\">SAO A/C No.</th>";
...
//--------------------daily sao loan issued list---------------------
if($statement==di)
{
echo "<table bgcolor=\"silver\" width=\"120%\" align=\"center\">";
$color="#CCCC0000";
echo "<tr>";
echo "<th colspan=\"12\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Daily SAO Loan Issued List--Date:";
echo "<tr>";
echo "<th rowspan=\"2\" bgcolor=\"$color\">Time</th>";
echo "<th rowspan=\"2\" bgcolor=\"$color\">SAO A/C No.</th>";
echo "<th rowspan=\"2\" bgcolor=\"$color\">Name</th>";
...
echo "<th colspan=\"7\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">SAO Loan Relatation, Society with Central Co-operative Bank</font></th>";
echo "<th rowspan=\"2\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">Own Fund</font></th>";
echo "<th colspan=\"8\" bgcolor=\"green\"><font color=WHITE size=\"4\" align=\"center\">SAO Loan Relatation,Society with Farmer</font></th>";
echo "<tr>";
