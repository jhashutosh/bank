...
URL="../mt/addDocument.php?menu=mt&account_no="+str+"&loan_sl_no="+mnu;
//alert(URL)
...
SelectPledgeDocument($mt_doc_type_array,$name='p_type');
//echo "<tr><td><b>Account No:<td><INPUT NAME=\"ac_no\" id=\"ac\" TYPE=\"TEXT\" VALUE=\"\" size=\"10\" $HIGHLIGHT >";
//echo "&nbsp;<INPUT TYPE=\"button\" name=\"s1\" VALUE=\"...\" onClick=\"openChild();\">";
echo "<tr><td><b>Asset Description:<td><INPUT NAME=\"ast_dsc\" TYPE=\"TEXT\" id=\"ast_dsc\" VALUE=\"\" size=\"10\" $HIGHLIGHT >";
echo "<tr><td><b>Registration No.<td><INPUT NAME=\"reg_no\" id=\"reg_no\" TYPE=\"TEXT\" VALUE=\"\" size=\"10\" $HIGHLIGHT >";
echo "<tr><td><B>Asset Value:<td>Rs.&nbsp<INPUT NAME=\"amount\" TYPE=\"TEXT\" id=\"amt\"  VALUE=\"\" size=\"10\" $HIGHLIGHT >";
...
frmvalidator.addValidation("ast_dsc","req","Please enter Asset Description");
//frmvalidator.addValidation("reg_no","req","Please enter Registration No.");
