...
if($b_d_principal>0)
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','$account_no','$gl_code_loan',$b_d_principal,'Dr','opening MT')";
if($b_od_prin>0)
{
	if($loan_status<>'o')
	{
		$gl_code_loan=$gl_code_loan+1;
		$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','$account_no','$gl_code_loan',$b_od_prin,'Dr','opening MT')";
	}
	else
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','$account_no','$gl_code_loan',$b_od_prin,'Dr','opening MT')";
}
...
echo "<tr><th bgcolor=\"#006400\" colspan=\"4\"><font size=+2>MT Loan Issue Form of [$account_no]</font>";
echo "<FORM NAME=\"f1\" method=\"POST\" action=\"mtl_loan_balance_ef.php?menu=$menu&op=v&account_no=$account_no&type=$type&repay_period=$repay_period&d_int_r=$due_int&od_int_r=$overdue_int&issued_amount=$issued_amount\">";
