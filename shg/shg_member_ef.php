...
if ($count==0){
echo "<tr bgcolor=\"#BDB76B\"><td align=\"left\" >Name of Member:<td colspan=2><input type=\"TEXT\" name=\"mname\" id=\"mname\" size=\"20\" value=\"$leader\" $HIGHLIGHT><br>";
echo "<input type=\"HIDDEN\" name=\"designation\"  value=\"l\">";
}
else if ($count==1){
echo "<tr bgcolor=\"#BDB76B\"><td align=\"left\" >Name of Member:<td colspan=2><input type=\"TEXT\" name=\"mname\" id=\"mname\" size=\"20\" value=\"\" $HIGHLIGHT><br>";
