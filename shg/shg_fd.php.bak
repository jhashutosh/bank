...
echo "<h1>Fixed Deposit Information Of SHG</h1>";
echo "<hr>";
$sql_statement="select * from deposit_info di,customer_shg_ac sa where sa.account_no=di.account_no and sa.account_type='fd'";
//echo $sql_statement;
...
echo "<tr><td bgcolor=\"green\" colspan=\"7\" align=\"center\"><font color=\"white\">List Of Fixed Deposits Of SHG</font>";
...
echo "<td align=right bgcolor=$color><a href=\"../main/pop_up_account.php?menu=fd&account_no=".$row['account_no']."\" onClick=\"window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes,top=100,left=150, width=1050,height=500'); return false;\">".$row['account_no']."</a></td>";
