...
echo "<td>Installment Principal[due]<td>Rs.&nbsp;<INPUT NAME=\"d_d_principal\" id=\"d_d_principal\" TYPE=\"TEXT\" VALUE=\"$due_principal\" $HIGHLIGHT size=10 >";
echo "<tr><td>Over Due Principal :<td>Rs.&nbsp;<INPUT NAME=\"r_od_principal\" TYPE=\"TEXT\" VALUE=\"$odp\" $HIGHLIGHT size=10 READONLY>";
echo "<td>Over Due Principal :<td>Rs.&nbsp;<INPUT NAME=\"d_od_principal\" id=\"d_od_principal\" TYPE=\"TEXT\" VALUE=\"$overdue_principal\" $HIGHLIGHT size=10 >";
