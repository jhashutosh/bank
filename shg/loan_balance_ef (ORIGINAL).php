...
if($_REQUEST['op']=='i'){
	...
	$t_id=getTranId();
	$last_repay_date=maturity_date($action_date,$repay_date,'m');
...
// Loan_Ledger_Hrd
	$sql_statement.=";INSERT INTO loan_ledger_hrd(loan_serial_no,loan_type,customer_id,account_no,issue_date,repay_date,period,int_due_rate, int_overdue_rate,payment_term,status,gl_code,gl_status) VALUES ('$loan_sl_no','sgl','$c_id','$account_no','$action_date', '$last_repay_date','$repay_date',$due_int,$overdue_int,'$payment_term','op','$gl_code_loan','$gl_status')";
// loan_return_dtl
...
echo "<tr><td bgcolor=\"#E6E6FA\">Payment Term :<td bgcolor=\"#E6E6FA\">";
echo "<SELECT name=\"payment_term\">";
echo "<option value=\"n\">Normal";
echo "<option value=\"m\">Monthly";
echo "<option value=\"q\">Quaterly";
echo "<option value=\"h\">Half-Yearly";
echo "<option value=\"y\">Yearly";
echo "</select>";
