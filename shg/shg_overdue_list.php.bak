...
echo "<h3><u><font color =\"red\">Report No.5</h3></u></font>";
echo "<h1>Overdue loan list for Shg groups";
echo "</h1>";
...
echo "<th bgcolor=$color colspan=\"1\">OverdueInterest</th>";
...
$i++;
  ...
  echo "<td align=right bgcolor=$color>".$row['int_overdue']."</td>";
$total =$row['principal']+$row['int_simple']+$row['int_overdue'];
