...
{  
echo "<form method=\"POST\" action=\"main_menu.php?menu=$menu\">";
echo "<table bgcolor=PINK align=center width=80%>";
echo "<tr bgcolor=black><TH colspan=5 bgcolor=GREEN><font color=WHITE size=+2><b>EMI Calculation Form";
...
echo "<td align=\"left\">Payment Terms:<td><input type=\"TEXT\" name=\"pay_term\" size=\"10\" value=\"$pay_term\" readonly $HIGHLIGHT>";
...
echo "<tr><td align=\"left\">Interest Rate:<td><input type=\"TEXT\" name=\"interest_rate\" size=\"10\" value=\"$rate_of_int\" $HIGHLIGHT><br>";
...
echo "<td align=\"left\">Applied Amount:<td><input type=\"TEXT\" name=\"applied_amount\" size=\"10\" value=\"$appl_amount\" $HIGHLIGHT><br>";
...
//echo "month=$months";
$installment=round($loan_amount/$months);
$emi=round(EMI_calculation($loan_amount,$rate_of_int,$months));
$int_installment=round($emi-$installment);
$total_interest=round(sprintf("%-12.2f",($emi*$months)-$loan_amount));
...
echo "<td align=\"left\">$pay_term Total Payment:<td><input type=\"TEXT\" name=\"int_emi\" size=\"10\" value=\"$emi\" $HIGHLIGHT><br>";
