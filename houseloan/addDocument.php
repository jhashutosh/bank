...
echo "<h1>$account_no</h1>";
if($load_status=='o'){$URL='house_loan_balance_ef.php?menu=house&action_date='.$entry_date;}
else{$URL='houseloan_ledger_ef.php?menu=house&action_date='.$entry_date;}
echo "<html>";
echo "<head>";
echo "<title>Security Deposit for house[$account_no]</title>";
...
function checkSelect(str){
	...
	if(str=='fd'||str=='rd'||str=='ri'||str=='mis'||str=='oth'||str=='ut'){
		if(str=='ut'){	
...
URL="../houseloan/addDocument.php?menu=hou&account_no="+str+"&loan_sl_no="+mnu;
//alert(URL)
