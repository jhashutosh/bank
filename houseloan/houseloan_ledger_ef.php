...
$URL1='houseloan_ledger_ef.php?menu=house&loan_sl_no=l';
echo "<html>";
echo "<head>";
...
//alert(str);
if(str=='ch'){
gethousehintissue(str,ac_no,menu);
...
echo "&nbsp;<input type=\"BUTTON\" name=\"Stright_to_issue\" value=\"Stright to issue\" value=\"Return\" onclick=\"myRefresh('".$URL1."')\"></th>";
}
else{
...
echo "<tr><td>Security Amount:<td>Rs.&nbsp<INPUT NAME=\"security_amount\" TYPE=\"TEXT\" VALUE=\"$sum_amount\" size=\"10\" $HIGHLIGHT > <a href=document_view.php?menu=house&account_no=$account_no>View</a>";
...
echo"<tr><td align=\"right\">Loan Issue Method</td><td width=\"2%\"  align=\"center\">:</td><td align=\"left\" colspan=\"4\"><select name='issue' onchange=\"f2(this.value,'$account_no','$menu');\"><option value=\"ca\">Cash</option><option value=\"ch\">Cheque</option></select></td></tr>";
}

echo "<tr><td colspan='6'><hr></td></tr><tr><td colspan=\"3\">";
}
?>
<span id="txtHint"></span>
<?php
if($im=='i'){
//change for requirements as stated on 2.09.13
$sql_statement="SELECT * FROM bank_bk_dtl WHERE (account_type='sb' OR account_type='ca') AND status='op'";
$result=dBConnect($sql_statement);
//echo $sql_statement;

echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Transfer from : <select name=\"bnk\"><option value=\"null\">select</option>";
...
echo"</td><td  align=\"right\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cheque Number:&nbsp;&nbsp;&nbsp;<input type='text' name=\"chq_no\" id=\"chq_no\" $HIGHLIGHT></td></tr>";

}
if(empty($_REQUEST['im'])){

echo "<td colspan=\"3\" align=\"right\"><input type=\"SUBMIT\" VALUE=\"    Go   \" $HIGHLIGHT>";
echo "</FORM>";
...
echo "<tr><td>Issuing Date:<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT NAME=\"action_date\" TYPE=\"TEXT\" VALUE=\"".$_REQUEST['action_date']."\" $HIGHLIGHT size=\"15\">";
echo "<td>Add Security Amount:<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "<INPUT TYPE=\"button\" VALUE=\"  Add  \" onClick=\"openChild('addDocument.php?menu=house','win2')\" DISABLED>";
...
echo "<tr><td>Security Amount:<td>Rs.&nbsp<INPUT NAME=\"security_amount\" TYPE=\"TEXT\" VALUE=\"".$_REQUEST['security_amount']."\" size=\"10\" $HIGHLIGHT> <a href=document_view.php?menu=house&account_no=$account_no>View</a>";

echo "<td>Period:<td>Rs.&nbsp<INPUT NAME=\"period\" TYPE=\"TEXT\" VALUE=\"".$_REQUEST['period']."\" size=\"10\" $HIGHLIGHT> &nbsp; Months";
echo "<tr><td>Applied Amount:<td>Rs.&nbsp<INPUT NAME=\"applied_amount\" TYPE=\"TEXT\" VALUE=\"$emi_calcu\" size=\"10\" $HIGHLIGHT>";
...
echo "<tr><td >Transfer to Your SB A/C : <INPUT NAME=\"t_status\"  TYPE=\"TEXT\" VALUE=\"y\" SIZE=\"1\" $HIGHLIGHT >";
echo "<td>Your SB A/C No. :<td><INPUT NAME=\"account_sb\" id=\"ac\" TYPE=\"TEXT\" VALUE=\"$account_sb\" size=\"10\" $HIGHLIGHT>";
...
if($_REQUEST['issue']=='ch'){
echo"<tr><td align=\"left\">Account Number:</td><td><input type='text' name=\"ac_num\" id=\"ac_num\" value=\"".$_REQUEST['bnk']."\" size=\"5\" $HIGHLIGHT></td>";
echo"<td align=\"left\">Cheque Number:</td><td><input type='text' name=\"chq_no\" id=\"chq_no\" value=\"".$_REQUEST['chq_no']."\" size=\"5\"$HIGHLIGHT></td></tr>";

}

echo "<tr><td align=\"right\" colspan=\"6\"><input type=\"SUBMIT\" VALUE=\"    Final  \"></tr>";
	}
 }
//============================================================================================
//+++++++++++++++++++++++++++++++++++++++++INSERT+++++++++++++++++++++++++++++++++++++++++++++
...
//gl_ledger_hrd
		 if($issue=='ca'){
		$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks,operator_code, entry_time) VALUES ('$t_id','hou','$action_date','$fy','$remarks','$staff_id', CAST('$action_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP))";
//gl_ledger_dtl ===== Dr.
...
//gl_ledger_dtl ===== Cr.
	...
	//For Transfer to SB A/C.
		...
		$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars,account_no) VALUES('$t_id','$gl_code',$issue_amount,'Cr','house issue','$account_sb')";
               ...
               if($issue=='ch'){
$sql_statement=$sql_statement.";INSERT INTO gl_ledger_hrd(tran_id,type, action_date,fy,remarks,operator_code, entry_time,cheque_no,cheque_dt) VALUES ('$t_id','hou','$action_date','$fy','$remarks','$staff_id', CAST('$action_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP),'$chq_no','$action_date')";
//Cr------------>
              $gl_bank_code=getGlCode4mBank($ac_num,$ac_typ);
          $part_cr='trf['.$account_no.']';
                 $sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,account_no,gl_mas_code,amount,dr_cr, particulars) VALUES   ('$t_id','$ac_num','$gl_bank_code',$issue_amount,'Cr','$part_cr')";
//Dr------------>
               $part_dr='trf['.$ac_num.']';
                $sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars,account_no) VALUES('$t_id','$gl_code',$issue_amount,'Dr','$part_dr','$account_no')";
                                 }
		//echo $sql_statement;
		$result=dBConnect($sql_statement);
