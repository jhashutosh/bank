...
$loan_no=$_SESSION["current_account_no"];
$tran_dt=date('d/m/Y');
...
$sql_statement="SELECT * FROM gl_ledger_hrd h,gl_ledger_dtl d WHERE account_no='$loan_account_no' AND h.tran_id=d.tran_id AND gl_mas_code='$gl_code' ORDER BY entry_time LIMIT 1";  
echo $sql_statement;
