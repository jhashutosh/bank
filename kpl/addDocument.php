...
if($load_status=='o'){$URL='kpl_loan_balance_ef.php?menu=kpl&action_date='.$entry_date;}
else{$URL='kpl_loan_issue_ef.php?menu=kpl&action_date='.$entry_date;}
echo "<html>";
echo "<head>";
...
SelectPledgeDocument($kpl_doc_type_array,$name='p_type');
