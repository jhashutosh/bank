...
echo "<h3>Account Statement [$account_no][<a href=\"../general/security_document.php?menu=$menu&account_no=$account_no\" onClick=\"window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=120,left=150, width=1000,height=600'); return false;\">Security Document</a>]";
echo "</h3><hr>";
...
echo "<td align=right bgcolor=$color>".amount2Rs($row['b_due_int'])."</td>";
echo "<td align=right bgcolor=$color>".amount2Rs($row['b_overdue_int'])."</td>";
