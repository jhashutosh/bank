...
echo "<font size=+2>Deposited Amount For FD";
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"fd_report_w.php?menu=$menu\">";
echo "Date::<input type=\"HIDDEN\" name=\"starting_date\" size=\"12\" value=\"$starting_date\" id=\"st_dt\" $HIGHLIGHT>";
...
echo "<tr><td bgcolor=\"red\" colspan=\"2\" align=\"center\"><font color=\"white\"><b>Deposited Amount Upto $ending_date</b></font>";
