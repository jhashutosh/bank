...
if( empty($starting_date) ) { $starting_date="01/04/2010"; }
...
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"sb_report_d.php?menu=$menu\">";
...
echo "<table valign=\"top\" width=\"50%\" align=\"center\" border=\"0\">";
