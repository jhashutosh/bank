...
//if( empty($starting_date) ) { $starting_date=date("d/m/Y",time()-630720000); }
if( empty($starting_date) ) { $starting_date="01/04/2000"; }
...
echo "<font size=+2 align=right>Withdrawals From - $name";
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"report_with.php?menu=$menu\">";
echo "Withdrawal date: <input type=\"HIDDEN\" name=\"starting_date\" size=\"12\" value=\"$starting_date\" id=\"st_dt\" $HIGHLIGHT >";
...
echo "<table valign=\"top\" width=\"50%\" align=\"center\" border=\"1\">";
echo "<tr><td bgcolor=\"red\" colspan=\"2\" align=\"center\"><font color=\"white\"><b>Withdrawals Amount upto $ending_date</b></font>";
...
echo "<tr>";
echo "<td align=right bgcolor=$color align=\"center\">".$row['action_date']."</td>";
echo "<td align=right bgcolor=$color align=\"center\">".$row['withdrawal']."</td>";
