...
$sql_statement="select count(account_no) as no_p_kcc from  customer_account where account_no like 'KCC-%' and opening_date<'$f_start_dt'"; 
...
echo "<td colspan=\"1\" bgcolor=\"$color\" align=right>".$row['no_p_kcc']."</td>";
}
}
...
$sql_statement=" SELECT sum(loan_amount) as tp_kcc FROM loan_statement WHERE action_date<='$start_date' and account_no LIKE 'KCC-%'"; 
...
//=========================================ks loan previous=============================================
$sql_statement=" select count(account_no) as no_p_lt from  customer_account where account_no like 'KS-%' and opening_date<'$f_start_dt'"; 
...
$color=$TCOLOR;
		...
		$color=($color==$TCOLOR)?$TBGCOLOR:$TCOLOR;
 		$row=pg_fetch_array($result,$j);
echo "<tr>";
echo "<th colspan=\"1\" bgcolor=\"$color\">KS LOAN</th>";
echo "<td colspan=\"1\" bgcolor=\"$color\" align=right>".$row['no_p_lt']."</td>";
}
}
$sql_statement="select sum(loan_amount) as tp_lt from loan_statement where account_no like 'KS-%' and action_date<='$f_start_dt'"; 
...
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan_p.php?menu=ks&op=d\">Lt Due List</A></td>";
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan_p1.php?menu=ks&op=o\">Lt overdue List</A></td>";

//===========================================lt loan current============================================
$sql_statement=" select count(account_no) as no_c_lt  from  customer_account where account_no like 'KS-%' and opening_date
<='$start_date'"; 
...
$sql_statement=" SELECT sum(loan_amount) as tp_lt FROM loan_statement WHERE action_date<='$start_date' and account_no LIKE 'KS-%'"; 
...
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan.php?menu=ks&op=d\">Lt Due List</A></td>";
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan1.php?menu=ks&op=o\">Lt overdue List</A></td>";
//echo "<td colspan=\"1\" bgcolor=\"$color\" align=right>".amount2RS($row['tp_lt']+$row['tdue_lt']+$row['todue_lt'])."</td>";

//===============================================lt loan amount return===================================
$sql_statement=" select count(count) as lt_r,sum(d) as lt_d_r,sum(o) as lt_o_r,sum(p) as lt_p_r from (SELECT count(account_no) as count,SUM(r_due_int) as d,SUM(r_overdue_int) as o,SUM(r_principal) as p FROM loan_statement WHERE tr_type='R' AND (action_date BETWEEN '1980/01/01' AND current_date) AND account_no LIKE 'KS%' GROUP BY account_no HAVING (SUM(r_due_int)>0 OR SUM(r_overdue_int)>0 OR SUM(r_principal)>0)) as foo"; 
...
//=========================================ks loan previous=============================================
$sql_statement=" select count(account_no) as no_p_lt from  customer_account where account_no like 'OFL-%' and opening_date<'$f_start_dt'"; 
...
$color=$TCOLOR;
		...
		$color=($color==$TCOLOR)?$TBGCOLOR:$TCOLOR;
 		$row=pg_fetch_array($result,$j);
echo "<tr>";
echo "<th colspan=\"1\" bgcolor=\"$color\">OFL LOAN</th>";
echo "<td colspan=\"1\" bgcolor=\"$color\" align=right>".$row['no_p_lt']."</td>";
}
}
$sql_statement="select sum(loan_amount) as tp_lt from loan_statement where account_no like 'OFL-%' and action_date<='$f_start_dt'"; 
...
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan_p.php?menu=ofl&op=d\">Lt Due List</A></td>";
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan_p1.php?menu=ofl&op=o\">Lt overdue List</A></td>";

//===========================================lt loan current============================================
$sql_statement=" select count(account_no) as no_c_lt  from  customer_account where account_no like 'OFL-%' and opening_date
<='$start_date'"; 
...
$sql_statement=" SELECT sum(loan_amount) as tp_lt FROM loan_statement WHERE action_date<='$start_date' and account_no LIKE 'OFL-%'"; 
...
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan.php?menu=ofl&op=d\">Lt Due List</A></td>";
echo "<td colspan=\"1\" bgcolor=\"$color\"><A HREF=\"list_of_loan1.php?menu=ofl&op=o\">Lt overdue List</A></td>";
//echo "<td colspan=\"1\" bgcolor=\"$color\" align=right>".amount2RS($row['tp_lt']+$row['tdue_lt']+$row['todue_lt'])."</td>";

//===============================================lt loan amount return===================================
$sql_statement=" select count(count) as lt_r,sum(d) as lt_d_r,sum(o) as lt_o_r,sum(p) as lt_p_r from (SELECT count(account_no) as count,SUM(r_due_int) as d,SUM(r_overdue_int) as o,SUM(r_principal) as p FROM loan_statement WHERE tr_type='R' AND (action_date BETWEEN '1980/01/01' AND current_date) AND account_no LIKE 'OFL%' GROUP BY account_no HAVING (SUM(r_due_int)>0 OR SUM(r_overdue_int)>0 OR SUM(r_principal)>0)) as foo"; 
...
// ========================================previous total part=======================================================
$sql_statement=" select count(account_no) as t_p_a FROM customer_account where (account_no like 'SPL-%' or  account_no like 'KCC-%' or account_no like 'MT-%' or account_no like 'CCL-%' or account_no like 'KPL-%' or account_no like 'SFL-%' or account_no like 'PL-%' OR account_no like 'KS-%' or account_no like 'BDL-%') and opening_date<='$f_start_dt'"; 
...
$sql_statement=" select sum(loan_amount) as t_p_amt FROM loan_statement where (account_no like 'SPL-%' or  account_no like 'KCC-%' or account_no like 'MT-%' or account_no like 'CCL-%' or account_no like 'KPL-%' or account_no like 'SFL-%' or account_no like 'PL-%' or account_no like 'KS-%' OR account_no like 'BDL-%') and action_date<='$f_start_dt'"; 
...
$sql_statement=" select sum(loan_amount) as t_c_amt FROM loan_statement where (account_no like 'SPL-%' or  account_no like 'KCC-%' or account_no like 'MT-%' or account_no like 'CCL-%' or account_no like 'KPL-%' or account_no like 'SFL-%' or account_no like 'PL-%' or account_no like 'KS-%' or account_no like 'BDL-%') and action_date<'$start_date'"; 
...
//=========================================return amount total===========================================
$sql_statement=" select count(count) as t_r,sum(d) as t_d_r,sum(o) as t_o_r,sum(p) as t_p_r from (SELECT count(account_no) as count,SUM(r_due_int) as d,SUM(r_overdue_int) as o,SUM(r_principal) as p FROM loan_statement WHERE tr_type='R' AND (action_date BETWEEN '1980/01/01' AND current_date) AND account_no LIKE 'SPL%' or  account_no LIKE 'KCC%' or account_no LIKE 'MT%' or account_no LIKE 'CCL%' or account_no LIKE 'KPL%' or account_no LIKE 'SFL%' or account_no LIKE 'PL%' or account_no like 'KS-%' or account_no LIKE 'BDL%' GROUP BY account_no HAVING (SUM(r_due_int)>0 OR SUM(r_overdue_int)>0 OR SUM(r_principal)>0)) as foo"; 
