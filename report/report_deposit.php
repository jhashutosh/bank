...
if( empty($starting_date) ) { $starting_date="05/02/1990"; }
...
echo "<font size=+2 align=right>Deposit to - $name";
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"report_deposit.php?menu=$menu\">";
echo "deposit date: <input type=\"HIDDEN\" name=\"starting_date\" size=\"12\" value=\"$starting_date\" id=\"st_dt\" $HIGHLIGHT >";
...
echo "<tr><td bgcolor=\"red\" colspan=\"2\" align=\"center\"><font color=\"white\"><b>Deposit Amount upto $ending_date</b></font>";
