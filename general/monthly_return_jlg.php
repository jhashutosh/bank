...
echo "<hr>";
echo "<form name=\"f1\" METHOD=\"POST\" ACTION=\"monthly_return_jlg.php\" onsubmit=\"return check();\">";
...
echo "<tr><td bgcolor=\"grey\" colspan=\"20\" align=\"center\"><b><font color=\"WHITE\">MONTHLY RETURN OF JOINT LIABILITY GROUP on <font color='lightgreen'>". $month_array[$months].",$year</font></td></tr></table>";
echo "<table border=\"1\" width='70%' align=center><tr><td bgcolor=\"#0000CD\" colspan=\"14\" align=\"center\"><b><font color=\"WHITE\"> JOINT LIABILITY GROUP Information on ". $month_array[$months].",$year</font>";
$sql_statement=" select mth_rpt_hrd_jlg('jlg','$end_dt','a')";
...
echo "<tr>";
echo "<td align=right>".$row['cnt_op'];
...
echo "<tr><td bgcolor=\"#0000CD\" colspan=\"15\" align=\"center\"><b><font color=\"WHITE\"> JOINT LIABILITY GROUP LOAN Information on  ". $month_array[$months].",$year</font>";
$sql_statement="select mth_rpt_ln_jlg('j','$end_dt','c')";
$sql_statement.=";fetch all from c";
echo $sql_statement;
$result=dBConnect($sql_statement);
$row=pg_fetch_array($result,0);
