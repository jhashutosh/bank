...
{ echo"<tr BGCOLOR='#839EB8'><th colspan='7' bgcolor='#0489B1'><font color=White>".$type_of_diposit_array[$row1['v_type']]." List </th></tr>";
	...
	elseif($row1['v_type']=='rd' || $row1['v_type']=='ri'|| $row1['v_type']=='fd')
		{
		 echo"<tr BGCOLOR='#839EB8'><th colspan='12' bgcolor='#0489B1'><font color=White>".$type_of_diposit_array[$row1['v_type']]." List </th></tr>";
...
if($row['v_type']=='fd'|| $row['v_type']=='rd' || $row['v_type']=='ri'){
//echo $sql;
...
{    if($row['v_type']=='sb'|| $row['v_type']=='gf'|| $row['v_type']=='tf'|| $row['v_type']=='sh')
	...
	elseif($row['v_type']=='rd' || $row['v_type']=='ri')
	 ...
	 if ($row1['v_type']=='sb'|| $row1['v_type']=='gf'|| $row1['v_type']=='tf'|| $row1['v_type']=='sh')
		{ 
		echo"</tr><tr BGCOLOR='black' ><td><br></td></tr></table><table BGCOLOR='black' align='center' width='80%'><tr BGCOLOR='#839EB8'><th colspan='7' bgcolor='#0489B1'><font color=White>".$type_of_diposit_array[$row1['v_type']]." List </th></tr>";
	...
	elseif($row1['v_type']=='rd' || $row1['v_type']=='ri')
		{ echo"</tr><tr BGCOLOR='black' ><td><br></td></tr></table><table BGCOLOR='black' align='center' width='100%'><tr BGCOLOR='#839EB8'><th colspan='12' bgcolor='#0489B1'><font color=White>".$type_of_diposit_array[$row1['v_type']]." List </th></tr>";
