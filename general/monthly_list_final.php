...
<li><a href="..//payroll/sal_reg_entry.php?menu=gen" onClick="window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=100,left=150, width=1210,height=1000'); return false;">Salary Register</A> - Monthly Salary Register
...
<li><a href="#" onClick="window.open(this.href,'_blank','toolbar=no,status=no,location=no,directories=no,resizeable=no,scrollbars=yes, top=100,left=150, width=1210,height=1000'); return false;">Investment-Maturity Register</A> - DCCB/SCB/Other Bank
