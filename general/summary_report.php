...
if ($menu=='hsb'){$table='hsb_detail_view';$name='HSB Deposit';}
...
echo "<font size=+2>Summary Statement - $name";
echo "</font>";
echo "<hr>";
echo "<form method=\"POST\" action=\"summary_report.php?menu=$menu\">";
echo "Summary statement of bank between <input type=\"TEXT\" name=\"starting_date\" size=\"12\" value=\"$starting_date\" id=\"st_dt\" $HIGHLIGHT>";
