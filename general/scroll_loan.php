...
if($menu=='ser'){ $name='Service Loan';$span=9; $WHERE_CONDITION="WHERE type='$menu' AND";}
if($menu=='fis'){ $name='Fishery Loan';$span=9; $WHERE_CONDITION="WHERE type='$menu' AND";}
if($menu=='car'){ $name='Car Loan';$span=9; $WHERE_CONDITION="WHERE type='$menu' AND";}
if($menu=='mt'){ $name='Mt Loan';$span=9; $WHERE_CONDITION="WHERE type='$menu' AND";}
