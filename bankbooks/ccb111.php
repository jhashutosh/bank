...
//echo $j;
$color='#839EB8';
echo"<tr><td size=1 align=center bgcolor='$color' colspan='2'><b>".$row['A/C TYPE']."</td><td bgcolor='$color' size=1 align=right><b>".$row['NO. OF A/CS']."</td><td size=1 align=right bgcolor='$color'><b>".amount2Rs($row['DEPOSIT BALANCE'])."</td><td bgcolor='$color' size=1 align=right><b>".amount2Rs($row['INT. RECEIVABLE'])."</td></tr>";
}
else{
//echo $j;
...
echo"<td bgcolor='$color' size=1 align=right>".$row[0]."</td><td size=1 bgcolor='$color' align=right>".$row[1]."</td><td bgcolor='$color' size=1 align=right>".$row['x3']."</td><td bgcolor='$color' size=1 align=right>".amount2Rs($in_rc)."</td></tr>";
}
