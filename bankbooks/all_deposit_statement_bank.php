...
echo "</title>";
echo "<hr>";
$sql_statement="SELECT * FROM bank_bk_dtl where account_sub_type='sb' or account_sub_type='ca' AND status='op'";
//echo "$sql_statement";
$result=dBConnect($sql_statement);
if(pg_NumRows($result)>0){
echo "<table align=center bgcolor=silver width=100%>";
echo "<tr><th colspan=5 bgcolor=#8A2BE2><font color=white>Sb Bank Account Details</font></th>";
