...
echo "</title>";
echo "<hr>";
$sql_statement="SELECT * FROM bank_bk_dtl where account_sub_type='shg' and b_name='H.D.C.C.B' AND status='op'";
//echo "$sql_statement";
$result=dBConnect($sql_statement);
if(pg_NumRows($result)>0){
echo "<table align=center bgcolor=silver width=100%>";
echo "<tr><th colspan=6 bgcolor=#8A2BE2><font color=white>SHG Bank Account Details</font></th>";
