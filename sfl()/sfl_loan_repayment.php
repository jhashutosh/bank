...
$sql_statement="SELECT getLoanInterest('$account_no',CURRENT_DATE,'sfl') as int";
}
else{
if($comp_method=='in')
$sql_statement="SELECT getLoanDtl('$action_date','$account_no','$loan_serial_no')";
else
$sql_statement="SELECT getLoanInterest('$account_no','$action_date','sfl') as int";
}
}
//echo $sql_statement;
...
echo "<html>";
echo "<head>";
echo "<title>Staff Loan Details </title>";
...
if(pg_NumRows($result)>0){
	$color="GREEN";
	echo "<tr><th bgcolor=YELLOW colspan=\"10\">Staff Loan Details of [$account_no] as on ".$action_date."</th>";
	echo "<tr>";
	...
	if(!empty($loan_sl_no)){
	echo "<td align=Center bgcolor=$color><a href=\"sfl_loan_repayment.php?menu=$menu&loan_no=$account_no&ln_sl=$loan_sl_no&op=r&action_date=$action_date\">Repay</td>";
	}
}
}
else{
 echo "<h1><center>Your dont have any Staff Loan!!!!!!!!!!!</h1></center>";
    }
  }
else{
 echo "<h1><font color=RED><center>Your dont have any Staff Loan for Payment!!!!!!!!!!!</h1></center>";
    }
}
//==================================FOR REPAY FORM=========================================
if($op=='r'){
...
echo "<tr><th bgcolor=\"#DF7679\" colspan=\"4\"><font size=+2>Staff Loan Repayment Form of [$account_no]</font>";
echo "<FORM NAME=\"orderform\" method=\"POST\" action=\"sfl_loan_repayment.php?menu=$menu&op=i&ln_sl=$ln_sl&loan_no=$account_no&id=$id\" onSubmit=\"return varify();\">";
...
//echo $sql_statement;
	...
	$sql_statement=$sql_statement.";INSERT INTO gl_ledger_dtl(tran_id,gl_mas_code,amount,dr_cr, particulars) VALUES('$t_id','28101',$re_tot_amt,'Dr','Staff Loan Repay')";
