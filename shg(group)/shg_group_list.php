...
echo "<h1> No. of existing SHG groups ";
echo "</h1>";
echo "<hr>";
$sql_statement="SELECT *  FROM shg_group_list";
...
$fmin=pg_result($result,'fmincount');
$mmin=pg_result($result,'mmincount');
...
echo "<tr><th bgcolor=\"green\" colspan=\"10\" align=\"center\"><font color=\"white\">Division of Shg group</font>";

// Place line comments if you do not need column header.
$color=$TCOLOR;
echo "<tr>";
echo "<th bgcolor=$color >Shg Member</th>";
...
echo "<th bgcolor=$color >Minority</th>";
...
$color=$TCOLOR;
	...
	echo "<td align=right bgcolor=$color>$mmin</td>";
	echo "<td align=right bgcolor=$color>$nmale</td>";
echo "<tr>";
...
>$fgroup</td>";
	...
	echo "<td align=right bgcolor=$color>$fmin</td>";
	echo "<td align=right bgcolor=$color>$nfemale</td>";
...
echo "<td align=right bgcolor=$color><B>$tmin</B></td>";
