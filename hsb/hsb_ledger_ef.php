...
$monthly=(float)checkHSB($account_no);

if(empty($monthly)){
echo "<form  method=\"POST\" name=\"f1\" action=\"hsb_ledger_evf.php?menu=$menu\" >";
echo "<table bgcolor=#66CDAA align=center width=90%>";
...
echo "<td align=\"left\">Period:<td><input type=\"TEXT\" name=\"period\" size=\"5\" value=\"\" $HIGHLIGHT>&nbsp;Days";
...
echo "<form method=\"POST\" name=\"f1\" action=\"hsb_ledger_evf.php?menu=$menu&op=m\" onsubmit=\"checkAmount(this.form);\">";
echo "<table bgcolor=#66CDAA align=center width=90%>";
