...
$sql_statement="INSERT INTO deposit_info (account_no, certificate_no, account_type, scheme, action_date,date_with_effect ,principal ,period, interest_rate, maturity_date, sb_account_no,operator_code, entry_time) VALUES ('$account_no','$account_no', '$menu', '$scheme','$opening_date','$date_with_effect', $amount_deposit,$period,$rate_of_interest,'$maturity_date','$holder_sb_account_no','$staff_id',CAST('$opening_date'||SUBSTR(CAST(now() AS VARCHAR),11,LENGTH(CAST(NOW() AS VARCHAR))) AS TIMESTAMP));";
	}
//gl_ledger_hrd
